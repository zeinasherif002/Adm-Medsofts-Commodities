...
export default function App() {
  ...
  {commodity==="corn"&&<div style={{background:"rgba(251,191,36,0.08)",border:"1px solid rgba(251,191,36,0.4)",borderRadius:16,padding:"16px 20px"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,marginBottom:10}}>
      <div style={{background:C.bg,borderRadius:8,padding:"10px 12px"}}><div style={{fontSize:10,color:C.sub,fontWeight:600,textTransform:"uppercase",marginBottom:4}}>Planted Acres (actual)</div><div style={{fontSize:14,fontWeight:700,color:C.text}}>TBD</div><div style={{fontSize:10,color:C.muted,marginTop:2}}>vs est. 95.3M</div></div>
      <div style={{background:C.bg,borderRadius:8,padding:"10px 12px"}}><div style={{fontSize:10,color:C.sub,fontWeight:600,textTransform:"uppercase",marginBottom:4}}>Jun 1 Grain Stocks</div><div style={{fontSize:14,fontWeight:700,color:C.text}}>TBD</div><div style={{fontSize:10,color:C.muted,marginTop:2}}>bushels</div></div>
      <div style={{background:C.bg,borderRadius:8,padding:"10px 12px"}}><div style={{fontSize:10,color:C.sub,fontWeight:600,textTransform:"uppercase",marginBottom:4}}>Price Reaction</div><div style={{fontSize:14,fontWeight:700,color:C.text}}>TBD</div><div style={{fontSize:10,color:C.muted,marginTop:2}}>vs prior close</div></div>
      <div style={{background:C.bg,borderRadius:8,padding:"10px 12px"}}><div style={{fontSize:10,color:C.sub,fontWeight:600,textTransform:"uppercase",marginBottom:4}}>Market Bias</div><div style={{fontSize:14,fontWeight:700,color:C.text}}>TBD</div><div style={{fontSize:10,color:C.muted,marginTop:2}}>ahead of Jul 10 WASDE</div></div>
    </div>
    <div style={{fontSize:11,color:C.sub,fontStyle:"italic"}}>Update this section once today's report figures are released. This is the most market-moving USDA report before the July WASDE — it sets the official 2026 planted acreage baseline.</div>
  </div>}
