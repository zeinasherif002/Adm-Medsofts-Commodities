  ...
  return(
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"'Inter','DM Sans','Segoe UI',sans-serif",display:"flex"}}>
      <div style={{width:230,minHeight:"100vh",background:C.sb,display:"flex",flexDirection:"column",position:"fixed",top:0,left:0,bottom:0,overflowY:"auto",borderRight:"1px solid "+C.border}}>
        <div style={{padding:"22px 20px 18px",borderBottom:"1px solid "+C.border}}><div style={{display:"flex",alignItems:"center",gap:12}}><div><img src="/media.jpg" alt="ADM MedSofts" style={{height:32,objectFit:"contain",filter:"brightness(0) invert(1)"}}/><div style={{fontSize:10,color:C.sub,marginTop:2}}>Commodity Intelligence</div></div></div></div>
