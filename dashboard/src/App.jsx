...
export default function App() {
  ...
  {(!wasde&&!wasdeWheat)&&<div style={{background:C.card,border:"1px solid "+C.border,borderRadius:16,padding:"32px",textAlign:"center",color:C.sub}}>No WASDE data available. Switch to Corn to see pre-WASDE analysis.</div>}<div style={{display:"flex",justifyContent:"flex-end",marginBottom:4}}><button onClick={function(){window.print();}} style={{padding:"9px 20px",borderRadius:10,border:"1px solid "+C.blue,background:"rgba(27,58,140,0.15)",color:C.blue,fontSize:12,cursor:"pointer",fontWeight:700}}>📄 Print / Export PDF</button></div>
