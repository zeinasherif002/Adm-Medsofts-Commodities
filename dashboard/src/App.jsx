...
export default function App() {
  ...
  useEffect(function(){loadData(commodity);loadWeekly(commodity);if(commodity==="corn"){loadCropCondition();loadWasde();}var iv=setInterval(function(){loadData(commodity);},5*60*1000);return function(){clearInterval(iv);};},[commodity]);
