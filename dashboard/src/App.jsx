...
export default function App() {
  ...
  function sendChatMessage(){
    ...
    var context = "You are an expert commodity market analyst for ADM MedSofts Egypt trading team.\n\n" +
      ...
      (L ? "CBOT Close: " + L.closing_cbot + " c/bu\nDate: " + L.date + "\nDollar Rate: " + L.dollar_rate + " EGP/USD\n" +
      (isWheat ? "11.5% Price: " + Math.round(L.arg_price) + " EGP\n12.5% Price: " + Math.round(L.brz_price) + " EGP\n" :
      "ARG Price: " + Math.round(L.arg_price) + " EGP\nBRZ Price: " + Math.round(L.brz_price) + " EGP\n") : "") +
      (cropCondition ? "USDA G+E Conditions: " + (cropCondition.excellent + cropCondition.good) + "%\n" : "") +
      (wasde ? "Pre-WASDE: Est. yield " + wasde.estimated_yield + " bu/ac, " + wasde.price_impact + "\n" : "") +
      "\nAnswer in a clear, professional way. If asked about recent news or events, search the web for the latest information.";

    var messages = chatMessages.concat([{role:"user",content:userMsg}]).map(function(m){
